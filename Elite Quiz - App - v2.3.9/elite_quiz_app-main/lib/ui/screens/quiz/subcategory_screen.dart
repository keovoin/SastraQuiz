...
class _SubCategoryScreenState extends State<SubCategoryScreen> {
  ...
  int subCategoryTotalQuestionsCount(Subcategory subCategory) {
    ...
    if (widget.args.quizType == QuizTypes.guessTheWord) {
      ...
      final subcategoryQuestions = int.tryParse(subCategory.noOfQue!) ?? 0;

      // If fixed questions is enabled, return the minimum of category count and limit
      if (isFixedQuestionsEnabled) {
        return subcategoryQuestions > maxQuestionsLimit
            ? maxQuestionsLimit
    ...
    return int.tryParse(subCategory.noOfQue!) ?? 0;
  }
      ...
      builder: (context, state) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            final totalQuestions = subCategoryTotalQuestionsCount(subcategory);
