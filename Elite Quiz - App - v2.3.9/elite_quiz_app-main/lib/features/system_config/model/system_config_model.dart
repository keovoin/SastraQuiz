...
final class SystemConfigModel {
  const SystemConfigModel({
    ...
    required this.quizZoneFixLevelQuestion,
    required this.quizZoneTotalLevelQuestion,
    required this.quizZoneTotalQuestion,
    required this.guessTheWordFixQuestion,
    required this.guessTheWordTotalQuestion,
    required this.audioQuizFixQuestion,
    required this.audioQuizTotalQuestion,
    required this.mathsQuizFixQuestion,
    required this.mathsQuizTotalQuestion,
    required this.funNLearnQuizFixQuestion,
    required this.funNLearnQuizTotalQuestion,
    required this.trueFalseQuizFixQuestion,
    required this.trueFalseQuizTotalQuestion,
    required this.multiMatchFixLevelQuestion,
    required this.multiMatchTotalLevelQuestion,
    required this.multiMatchTotalQuestion,
  });
  ...
  SystemConfigModel.fromJson(Map<String, dynamic> json)
    : adsEnabled = json['in_app_ads_mode'] == '1',
      ...
      quizZoneFixLevelQuestion = int.parse(
        json['quiz_zone_fix_level_question'] as String? ?? '0',
      ),
      quizZoneTotalLevelQuestion = int.parse(
        json['quiz_zone_total_level_question'] as String? ?? '0',
      ),
      quizZoneTotalQuestion = int.parse(
        json['quiz_zone_total_question'] as String? ?? '0',
      ),
      guessTheWordFixQuestion = int.parse(
        json['guess_the_word_fix_question'] as String? ?? '0',
      ),
      guessTheWordTotalQuestion = int.parse(
        json['guess_the_word_total_question'] as String? ?? '0',
      ),
      audioQuizFixQuestion = int.parse(
        json['audio_quiz_fix_question'] as String? ?? '0',
      ),
      audioQuizTotalQuestion = int.parse(
        json['audio_quiz_total_question'] as String? ?? '0',
      ),
      mathsQuizFixQuestion = int.parse(
        json['maths_quiz_fix_question'] as String? ?? '0',
      ),
      mathsQuizTotalQuestion = int.parse(
        json['maths_quiz_total_question'] as String? ?? '0',
      ),
      funNLearnQuizFixQuestion = int.parse(
        json['fun_n_learn_quiz_fix_question'] as String? ?? '0',
      ),
      funNLearnQuizTotalQuestion = int.parse(
        json['fun_n_learn_quiz_total_question'] as String? ?? '0',
      ),
      trueFalseQuizFixQuestion = int.parse(
        json['true_false_quiz_fix_question'] as String? ?? '0',
      ),
      trueFalseQuizTotalQuestion = int.parse(
        json['true_false_quiz_total_question'] as String? ?? '0',
      ),
      multiMatchFixLevelQuestion = int.parse(
        json['multi_match_fix_level_question'] as String? ?? '0',
      ),
      multiMatchTotalLevelQuestion = int.parse(
        json['multi_match_total_level_question'] as String? ?? '0',
      ),
      multiMatchTotalQuestion = int.parse(
        json['multi_match_total_question'] as String? ?? '0',
      );
  ...
  final int quizZoneFixLevelQuestion;
  final int quizZoneTotalLevelQuestion;
  final int quizZoneTotalQuestion;
  final int guessTheWordFixQuestion;
  final int guessTheWordTotalQuestion;
  final int audioQuizFixQuestion;
  final int audioQuizTotalQuestion;
  final int mathsQuizFixQuestion;
  final int mathsQuizTotalQuestion;
  final int funNLearnQuizFixQuestion;
  final int funNLearnQuizTotalQuestion;
  final int trueFalseQuizFixQuestion;
  final int trueFalseQuizTotalQuestion;
  final int multiMatchFixLevelQuestion;
  final int multiMatchTotalLevelQuestion;
  final int multiMatchTotalQuestion;
}
