...
class AuthRemoteDataSource {
  ...
  Future<Map<String, dynamic>> addUser({
    ...
    try {
      ...
      final response = await http.post(Uri.parse(addUserUrl), body: requestBody);
  ...
  Future<String> getJWTTokenOfUser({
    ...
    try {
      //body of post request
      requestBody = <String, String>{firebaseIdKey: firebaseId, typeKey: type};
  ...
  Future<bool> isUserExist(String firebaseId) async {
    ...
    try {
      requestBody = {firebaseIdKey: firebaseId};
