      ...
      if (category.hasLevel) {
        ...
        Navigator.of(globalCtx).pushNamed(
          ...
          arguments: {
            ...
            ///This will determine that we need to call the get question by category/subcategory
            'level': '0',
    ...
    return GestureDetector(
      ...
      child: LayoutBuilder(
        builder: (context, boxConstraints) {
          ...
          //This is the default total questions for quiz zone categories and subcategories
          ...
          //This will be shown only when the category does not have subcategories and levels
          final totalCategoryQuestions =
              category.questionsCount > quizZoneTotalQuestion!
              ? quizZoneTotalQuestion
                          ...
                          children: [
                            ...
                            Text(
                              category.hasSubcategories
                                  ...
                                  : "${context.tr("questions")!}: $totalCategoryQuestions",
                              style: TextStyle(
                                fontSize: 14,
                                color: context.primaryTextColor.withValues(
                                  alpha: 0.6,
